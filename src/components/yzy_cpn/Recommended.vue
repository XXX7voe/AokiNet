...
.earnings :nth-child(1){
    color: #666;
    font-family: Helvetica Neue,Tahoma,Arial;
    font-size: 0.15rem;
}
.earnings :nth-child(2){
    color: #ff5633;
    font-family: Helvetica Neue,Tahoma,Arial;
    font-size: 0.15rem;
    font-weight: 700;
